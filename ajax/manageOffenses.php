...
if ($type == "add") {
    ...
    $sql = $mysqli_connect->query("INSERT INTO tbl_offenses SET student_id='$student_id',offense_date='$offense_date',offense_remarks='$offense_remarks', date_added='$date', violation_id='$violation_id'") or die(mysqli_error());
    ...
    $sql = $mysqli_connect->query("UPDATE tbl_offenses SET student_id='$student_id', offense_date='$offense_date', offense_remarks='$offense_remarks',violation_id='$violation_id' WHERE offense_id ='$offense_id'") or die(mysqli_error());
    if ($sql) {
        echo 1;
    } else {
        echo 0;
