          ...
          <div class="row">
              ...
              <div class="mb-3">
                ...
                <select class="select2 form-control" id="student_id" name="student_id" required>
                  ...
                  while ($sRow = $fetch_student->fetch_array()) { ?>
                    <option value='<?= $sRow['student_id'] ?>'><?= $sRow['student_fname'] . " " . $sRow['student_mname'] . " " . $sRow['student_lname'] ?></option>";
                  <?php }  ?>
                </select>
              </div>
            </div>
            <div class="col-sm-4">
              <div class="mb-3">
                ...
                <input type="date" class="form-control" id="offense_date" name="offense_date" required autocomplete="off">
              </div>
            </div>
            <div class="col-sm-12">
              <div class="mb-3">
                <label class="form-label">Remarks</label>
                <textarea class="form-control" style="height: 100px;" id="offense_remarks" name="offense_remarks" autocomplete="off"></textarea>
              </div>
            </div>
            <!-- <div class="mb-3">
