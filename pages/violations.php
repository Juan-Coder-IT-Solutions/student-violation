...
<script>
  ...
  function deleteEntry() {
    ...
    var tb = "tbl_violations";
    var keyword = "violation_id";
  ...
  function getEntryDetails(id) {
    ...
    $.ajax({
      ...
      success: function(data) {
        ...
        console.log(data);
        $("#violation_name").val(json.violation_name);
        $("#violation_desc").val(json.violation_desc);
      ...
      "columns": [
        {
          "mRender": function(data, type, row) {
            return "<div class='form-check form-check-success'><label class='form-check-label'><input type='checkbox' value=" + row.violation_id + " class='dt_id form-check-input'><i class='input-helper'></i></label></div>";
          }
        },
        {
          "mRender": function(data, type, row) {
            return "<center><button class='btn btn-primary' onclick='getEntryDetails(" + row.violation_id + ")'><span class='mdi mdi-grease-pencil'></span></button></center>";
          }
        },
        {
          "data": "count"
