...
<?php require_once 'modals/modal_degree.php'; ?>
<script>
  ...
  function getEntryDetails(id) {
    ...
    $.ajax({
      ...
      success: function(data) {
        ...
        console.log(data);
        $("#degree_name").val(json.degree_name);
  ...
  function getEntry() {
    ...
    $("#dt_details").DataTable({
      ...
      "ajax": {
        "type": "POST",
        "url": "ajax/datatables/degree.php",
        "dataSrc": "data",
        "data": {
          //type:type
        }
      ...
      "columns": [
        {
          "mRender": function(data, type, row) {
            return "<div class='form-check form-check-success'><label class='form-check-label'><input type='checkbox' value=" + row.degree_id + " class='dt_id form-check-input'><i class='input-helper'></i></label></div>";
          }
        },
        {
          "mRender": function(data, type, row) {
            return "<center><button class='btn btn-primary' onclick='getEntryDetails(" + row.degree_id + ")'><span class='mdi mdi-grease-pencil'></span></button></center>";
          }
        },
        {
          "data": "count"
